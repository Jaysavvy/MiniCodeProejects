...
app.post('/addRapper', (request, response) => {
    db.collection('quotes').insertOne({stageName: request.body.stageName,
...
app.put('/addOneLike', (request, response) => {
    db.collection('quotes').updateOne({stageName: request.body.stageNameS, birthName: request.body.birthNameS,likes: request.body.likesS},{
        $set: {
